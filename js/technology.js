...
const TECHS = [
  ...
  { id: 'biosphere', name: 'Living Swarm', k: 50000, branch: 'biotech', needs: 'genecraft',
    exclusive: 'star',
  ...
  { id: 'starlifting', name: 'Stellar Plasma Tapping', k: 50000, branch: 'nuclear', needs: 'fusion',
    exclusive: 'star',
  ...
  { id: 'dyson', name: 'Dyson Swarm', k: 50000, branch: 'solar', needs: 'orbitalmirror',
    exclusive: 'star',
  ...
  { id: 'matrioshka', name: 'Matrioshka Archive', k: 50000, branch: 'info', needs: 'computation',
    exclusive: 'star',
  ...
  { id: 'starmind', name: 'Stellar Mind', k: 50000, branch: 'network', needs: 'biolink',
    exclusive: 'star',
  ...
  { id: 'galacticmind', name: 'Galactic Nervous System', k: 500000, branch: 'network',
  ...
  { id: 'ringworld', name: 'Stellar Megastructure', k: 50000, branch: 'mega', needs: 'worldhouse',
    exclusive: 'star',
  ...
  { id: 'galactic', name: 'Galactic Expansion', k: 500000, branch: 'universal',
